...
Scope: implement the state-read containment fix identified in `review/Review_260720_theme_reach.md` as
...
grep across `*.md` also turned up mentions in `review/Snapshot_260717_theming_state.md`, `NOTES.md`,
...
`review/Review_260720_theme_reach.md` / the fade-orphan theory from an earlier session): if
