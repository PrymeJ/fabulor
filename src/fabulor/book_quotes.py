BOOK_QUOTES = [
    ...
    ("Apártense, vacas, que la vida es corta.", "Cien años de soledad", 22, 14, "white", "right"),
    ...
    ("Call me Ishmael.", "Moby-Dick; or, The Whale", 24, 14, "white", "right"),
    ("It was the best of times, it was the worst of times...", "A Tale of Two Cities", 18, 14, "white", "right"),
    ("Violence is the last refuge of the incompetent.", "Foundation", 18, 14, "white", "right"),
    ...
    ("Give a man a fire and he's warm for a day, but set fire to him and he's warm for the rest of his life.", "Jingo", 16, 14, "white", "right"),
