...
tags_kbdnav_ring: (Optional) Color of the keyboard-cursor focus ring drawn over the tag detail panel's thumbnail grid and color-picker dots (_ThumbFocusRing/_DotFocusRing, tag_manager.py). Was hardcoded white before 2026-09-08, which read poorly against light-background themes. Fallback: accent.
