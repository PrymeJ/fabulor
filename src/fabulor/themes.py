...
excluded_scrollbar: (Optional) Background of the Excluded Books popup's scrollbar handle (ui/excluded_books.py). Plain accent blended visually into ExcludedBooksSection's expand arrow directly above it (also accent) — falls back to a derived subdued tint (see _derive_subdued in excluded_books.py) rather than accent itself. Fallback: a desaturated/darkened accent, not accent.
